...
extension Locale {
    ...
    /// Provides the mapping from ISO3166-1 alpha-2 to ISO3166-1 alpha-1 language codes, so Locale language codes can be converted.
    public static var iso3166_1Dictionary: [String: String]? = {
